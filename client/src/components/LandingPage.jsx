                    ...
                    <div className="flex-1 max-w-xl">
                        ...
                        <div className="flex space-x-4 max-w-sm">
                            <button
                                ...
                                className="flex-1 py-3 rounded-lg font-semibold text-white cursor-pointer bg-[#387ED1] hover:bg-blue-600 transition duration-200 shadow-lg"
                            >
                                <span>Login</span>
                            </button>
                            <button
                                onClick={() => setModalView('register')}
                                className="flex-1 py-3 rounded-lg font-semibold text-gray-800 cursor-pointer bg-gray-200 border border-gray-300 hover:bg-gray-300 transition duration-200 shadow-lg"
                            >
                                <span>Register</span>
                            </button>
                        </div>
